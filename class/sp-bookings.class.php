...
class SP_Bookings
{
	...
	public function plugin_menu()
	{
		...
		add_submenu_page('so_dachsbau-karow-coach-menu', esc_html__('Trainer Export', 'timetable'), esc_html__('Trainer Export', 'timetable'), 'read', 'timetable_coach_bookings_export', array($this, 'bookings_export_page'));
	}
